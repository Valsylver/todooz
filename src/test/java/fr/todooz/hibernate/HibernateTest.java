...
public class HibernateTest {
	...
	/**
	 * @Test public void createSessionFactory() { Configuration configuration =
	 *       new Configuration(); configuration.setProperty("hibernate.dialect",
	 *       "org.hibernate.dialect.DerbyDialect");
	 *       configuration.setProperty("hibernate.connection.url",
	 *       "jdbc:derby:target/testdb;create=true");
	 *       configuration.setProperty("hibernate.connection.driver_class",
	 *       "org.apache.derby.jdbc.EmbeddedDriver");
	 *       configuration.setProperty("hibernate.hbm2ddl.auto", "create-drop");
	 *       configuration.addAnnotatedClass(Task.class); SessionFactory
	 *       sessionFactory = configuration.buildSessionFactory(); }
	 **/
